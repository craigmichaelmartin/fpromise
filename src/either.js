...
const ensureData = data => (data instanceof Data ? data : Data(data));
...
const bmap = (f, g) => [
  o => ensureData(o).bmap(f, g),
  o => ensureIssue(o).bmap(f, g)
];
const raw = f => [o => ensureData(o).raw(f), o => ensureIssue(o).raw(f)];
const iraw = f => [o => ensureData(o).iraw(f), o => ensureIssue(o).iraw(f)];
const braw = (f, g) => [
  o => ensureData(o).braw(f, g),
  o => ensureIssue(o).braw(f, g)
];
const tap = f => [o => ensureData(o).tap(f), o => ensureIssue(o).tap(f)];
const itap = f => [o => ensureData(o).itap(f), o => ensureIssue(o).itap(f)];
const btap = (f, g) => [
  o => ensureData(o).btap(f, g),
  o => ensureIssue(o).btap(f, g)
];
